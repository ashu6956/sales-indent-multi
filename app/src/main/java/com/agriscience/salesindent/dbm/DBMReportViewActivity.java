...
public class DBMReportViewActivity extends AppCompatActivity {
...
//    String AxRejectRemarksChecks="";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dbmreport_view);
...
//        appLocationService = new AppLocationService(DBMReportViewActivity.this);
//
...
//        getData3();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new DbmApprovedFragment(), "Approved");
        adapter.addFragment(new DbmRejectedFragment(), "Rejected");
        adapter.addFragment(new DbmAutoApprovedFragment(), "AutoApprove");
        adapter.addFragment(new DbmPendingFragment(), "Pending");
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new DbmApprovedFragment();
                case 1:
                    return new DbmRejectedFragment();
                case 2:
                    return new DbmAutoApprovedFragment();
                case 3:
                    return new DbmPendingFragment();
            }
            return null;
        }
...
//        FullIPData="";
//
//        FullIPData=  FinalIPAddress+"/kanagaraj/"+ProjectFolder+"/ISIndentDataFetchDBMMALLReport.php?DBMCode="+POCodeGet;
////        FullIPData=  "http://192.168.35.24/hyveg/Sales_Indent_App/"+ProjectFolder+"/ISIndentDataFetchDBMMALLReport.php?DBMCode="+POCodeGet;
//
//
//
...
//                        showAlertDialogWarning(DBMReportViewActivity.this, "No Internet Connection",
...
//                LayoutInflater inflater = DBMReportViewActivity.this.getLayoutInflater();
