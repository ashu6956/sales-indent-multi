...
public class DbmApprovedFragment extends Fragment {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    List<String> cody=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_dbmapproved, container, false);
...
*/
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getDbmApprovalStatus()!=null && detailsResponse.getDbmApprovalStatus().trim().equalsIgnoreCase("APPROVED")) {
...
//                    codes4.add(L);
               ...
               /* LayoutInflater inflater = getLayoutInflater();
                ...
                if (Check.equals("chckfile")) {
                    ...
                    Toast.makeText(getActivity(), "No Data Available 1", Toast.LENGTH_SHORT).show();
                    prgDialog.cancel();
                    //finish();
                ...
                Toast.makeText(getActivity(), "No Data Available 2", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
                prgDialog.cancel();
                approvedHeaderView.setVisibility(View.GONE);
            }
...
//            }
            ...
            Log.d("stringssssss","------"+position+"--APPROVED-----123--"+item_remarks_string[position]);

            if(!item_remarks_string[position].equals(""))
            {
                Log.d("stringssssss","------"+position+"--APPROVED-----"+item_remarks_string[position]);
