...
public class DbmPendingFragment extends Fragment {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_dbmpending, container, false);
...
//                prgDialog.hide();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getDbmApprovalStatus() != null && detailsResponse.getDbmApprovalStatus().trim().equalsIgnoreCase("PENDING")) {
...
//            }
           ...
           holder.item_remarks.setText(item_remarks_string[position]);
            ...
            Log.d("stringssssss","-------------pending----------------"+item_remarks_string[position]);
