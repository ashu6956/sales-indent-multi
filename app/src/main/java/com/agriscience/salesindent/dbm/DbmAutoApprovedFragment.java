...
public class DbmAutoApprovedFragment extends Fragment {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    public DbmAutoApprovedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_dbmauto_approve, container, false);
        appLocationService = new AppLocationService(getActivity());
        appSharedPreferences =new AppSharedPreferences(requireActivity());
        apiInterface = ApiClient.getClient().create(ApiInterface.class);

        autoApprovedListView = (ListView) view.findViewById(R.id.listView);
...
//                    HttpPost httppost = new HttpPost(new_api.ISIndentDataFetchDBMMALLReport(ProjectFolder ,POCodeGet ,Acting ,DCode));
...
//            }
            ...
            Log.d("stringssssss","-------------autoapprove----------------"+item_remarks_String[position]);
