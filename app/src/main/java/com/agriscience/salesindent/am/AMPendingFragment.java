...
public class AMPendingFragment extends Fragment {
...
//        FullIPData=  new_api.ISIndentDataFetchRBMMALLReport(ProjectFolder ,POCodeGet);
...
//                    codes4.add(L);
    ...
    private void callSalesIndentStatusApi(String amId) {
//        prgDialog.show();
        Call<SalesIndentStatusResponse> call = apiInterface.getAllAMStatusDetails(amId);
...
//                prgDialog.hide();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getAmApprovalStatus() != null && detailsResponse.getAmApprovalStatus().trim().equalsIgnoreCase("PENDING")) {
                pendingHeaderView.setVisibility(View.VISIBLE);
...
//            }
            ...
            holder.AxStatuss.setText(detailsResponse.getAmApprovalStatus());
...
//            }
            ...
            Log.d("rejectedstringssssss","---------"+item_remarks_string[position]);
