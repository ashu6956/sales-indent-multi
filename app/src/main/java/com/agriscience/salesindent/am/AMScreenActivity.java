...
import com.agriscience.salesindent.storbm.RbmStockReport;
import com.agriscience.salesindent.storbm.StockTransferCreateActivity;
...
public class AMScreenActivity extends Activity  implements  GoogleApiClient.ConnectionCallbacks,    GoogleApiClient.OnConnectionFailedListener {
    ...
    String ActivityType, subActivity, PoCodeSpinner, VillageNameSpineer, Transdate, SupportingPo, Remark, PoState, PoRegion, PoTerritory, OpenStatus, ApprovalStatus,TalukMandals;
...
//    GridView grid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amscreen);
        ...
        mFirebaseRemoteConfig.fetch().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(AMScreenActivity.this, "Someting went wrong please try again",
        ...
        appLocationService = new AppLocationService(AMScreenActivity.this);
        ...
        tvTmMenu =(TextView) findViewById(R.id.tvAMTmMenu);
     ...
     /*   mGoogleApiClient = new GoogleApiClient.Builder(this)
        ...
        // upLoadServerUri = "http://10.20.1.37:8080/kanagaraj/IndentSales/upload_to_server.php";

        upLoadServerUri = "http://210.212.238.34:8081/kanagaraj/IndentSales/upload_to_server.php";
...
//        dbStockTransfer = openOrCreateDatabase(StockTransferPath.getPath(), Context.MODE_PRIVATE, null);

//        DeleteStockTransferDetailsTemp();
//        createTableStockTransferDetailsTemp();

        CustomGrids adapter = new CustomGrids(AMScreenActivity.this, web, imageId);
        ...
        if (extras != null) {
            ...
            appSharedPreferences.put_ZM("login_RBM");
...
//            TMMenuCheck();
            ...
            // need to check later
            if(appSharedPreferences.getIsRbm() && appSharedPreferences.getIsTM()){
                tvTmMenu.setVisibility(View.VISIBLE);
            }
            else {
                tvTmMenu.setVisibility(View.GONE);
            }
            ...
            tvTmMenu.setOnClickListener(arg0 -> {
                navigateToTMLevel();
            });
    ...
    private void saveDivisionAndTerritoryId()
    {
        SalesIndentDataBase.databaseWriteExecutor.execute(() -> {
            ZOrganogramResponseDetails organogramDetails = SalesIndentDataBase.getDataBase(this).zOrganogramDetailsDao().getZOrganogramDetailsByRbmId(appSharedPreferences.getUserId());
    ...
    private void navigateToTMLevel() {
...
////        intent.putExtra("Division_code", Acting);
...
//        TMMenuSave();
    ...
    public void checkwifi() {
        ...
        if (isConnectionExist || isConnectionExistMobile) {
            ...
            showAlertDialog(AMScreenActivity.this, "No Internet Connection",
    ...
    private void indentactivity() {
      ...
      /*  if (IndentName.equals("GET MASTER")) {
           // GetSyn5();

        }

        if (IndentName.equals("UPLOAD")) {
        ...
        if (IndentName.equals("INDENT APPROVE")) {
            ...
            if (isConnectionExist || isConnectionExistMobile) {
                Intent intent = new Intent(this, AMIndentApprovalProcess.class);
                intent.putExtra("Po_code", POCodeGet);
                intent.putExtra("Po_name", PONameGet);
                intent.putExtra("Tm_name", TerritoryNameGet);
                intent.putExtra("Post_code", PostCodeTransferGet);
        ...
        if (IndentName.equals("INDENT STATUS")) {
            if(appSharedPreferences.get_version()== getcurrentversioncode()) {
                Intent intent = new Intent(this, AMReportViewActivity.class);
                intent.putExtra("Po_code", POCodeGet);
                intent.putExtra("Po_name", PONameGet);
                intent.putExtra("Tm_name", TerritoryNameGet);
                intent.putExtra("Post_code", PostCodeTransferGet);
        ...
        if (IndentName.equals("STOCK CREATE(STR)")) {
            if(appSharedPreferences.get_version()== getcurrentversioncode()) {
                Intent intent = new Intent(this, StockTransferCreateActivity.class);
                intent.putExtra("Po_code", POCodeGet);
                intent.putExtra("Po_name", PONameGet);
                intent.putExtra("Tm_name", TerritoryNameGet);
                intent.putExtra("Post_code", PostCodeTransferGet);
        ...
        if (IndentName.equals("STR STATUS")) {
            ...
            Intent intent = new Intent(this, RbmStockReport.class);
            intent.putExtra("Po_code", POCodeGet);
            intent.putExtra("Po_name", PONameGet);
            intent.putExtra("Tm_name", TerritoryNameGet);
            intent.putExtra("Post_code", PostCodeTransferGet);
        ...
        if (IndentName.equals("LOGOUT")) {
            ...
            SalesIndentDataBase.databaseWriteExecutor.execute(new Runnable() {
                @Override
                public void run() {
                    clearDB();
                    runOnUiThread(() -> {
    ...
    private void clearDB() {
        ...
        SalesIndentDataBase salesIndentDataBase = SalesIndentDataBase.getDataBase(AMScreenActivity.this);
        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result){
                ...
                try {
                    ...
                    prgDialog.cancel();
                    Toast.makeText(AMScreenActivity.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
...
//                    HttpPost httpPost = new HttpPost(IPAddress + "/kanagaraj/"+ProjectFolder+"/ISIndentLineDataSynInsert.php");
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        AMScreenActivity.this.startActivity(intent);
    ...
    public void ApproveActivity(View view) {
    ...
    protected void createTableSalesIndentApprove(){
        ...
        dbSalesIndent.execSQL("CREATE TABLE IF NOT EXISTS SalesIndentApprove(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, IndentNo VARCHAR, AXRecID VARCHAR ,AXQty REAL, IndentTypes VARCHAR,ApproveType VARCHAR,RejectRemarks VARCHAR);");
    ...
    protected void createTableSalesIndentApproveTemp(){
        ...
        dbSalesIndent.execSQL("CREATE TABLE IF NOT EXISTS SalesIndentApproveTemp(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, IndentNo VARCHAR, AXRecID VARCHAR ,AXQty REAL, IndentTypes VARCHAR,ApproveType VARCHAR,RejectRemarks VARCHAR);");
    ...
    public void ISloginMasterOfflineFileCheck() {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                POCodeGet = country[1].toString();
                PONameGet = country[2].toString();
                TerritoryNameGet = country[3].toString();
                PostCodeTransferGet = country[5].toString();
                SiteGet= country[13].toString();
                DivisionGet = country[15].toString();
