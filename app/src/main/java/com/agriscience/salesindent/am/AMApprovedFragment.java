...
public class AMApprovedFragment extends Fragment {
...
//        prgDialog.show();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getAmApprovalStatus()!=null && detailsResponse.getAmApprovalStatus().trim().equalsIgnoreCase("APPROVED")) {
...
//        FullIPData=  IPAddress+"/kanagaraj/"+ProjectFolder+"/ISIndentDataFetchRBMMALLReport.php?RBMCode="+POCodeGet;
