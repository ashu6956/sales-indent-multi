...
public class AMAutoApproveFragment extends Fragment {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    LinearLayout autoApprovedHeaderView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_auto_approve, container, false);
        appLocationService = new AppLocationService(getActivity());
        appSharedPreferences = new AppSharedPreferences(requireActivity());
        apiInterface = ApiClient.getClient().create(ApiInterface.class);
        autoApprovedListView = view.findViewById(R.id.listView);


        autoApprovedHeaderView = (LinearLayout) view.findViewById(R.id.Header);
...
//        getData3();
    ...
    private void IndentActivity() {
        ...
        Intent intent = new Intent(getActivity(), AMIndentSelection.class);
...
*/
    public void getData3() {
        ...
        FullIPData = IPAddress + ProjectFolder + "/ISIndentDataFetchRBMMALLReport.php?RBMCode=" + POCodeGet;
...
//                    HttpPost httppost = new HttpPost(new_api.ISIndentDataFetchRBMMALLReport(ProjectFolder ,POCodeGet));
    ...
    protected void showList3() {
        ...
        if (isConnectionExist || isConnectionExistMobile) {
            ...
            autoApprovedListView.setAdapter(null);
...
//                    codes4.add(L);
               ...
               /* LayoutInflater inflater = getLayoutInflater();
                ...
                // list.addFooterView(footer, null, false); */
                    ...
                    autoApprovedListView.setAdapter(myListAdapter);
                    setListViewHeightBasedOnItems(autoApprovedListView);
                ...
                if (Check.equals("chckfile")) {
                    ...
                    autoApprovedListView.setVisibility(View.VISIBLE);
                    autoApprovedHeaderView.setVisibility(View.VISIBLE);
                    ...
                    prgDialog.cancel();
                    //finish();
                    autoApprovedHeaderView.setVisibility(View.GONE);
                }
        ...
        call.enqueue(new Callback<SalesIndentStatusResponse>() {
            ...
            public void onResponse(Call<SalesIndentStatusResponse> call, Response<SalesIndentStatusResponse> response) {
                ...
                if (statusResponse.getResult() != null && statusResponse.getResult().size() > 0) {
                    ...
                    autoApprovedListView.setAdapter(statusListAdapter);
                    setListViewHeightBasedOnChildren(autoApprovedListView);
                } else {
                    autoApprovedListView.setVisibility(View.GONE);
                }
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getDbmApprovalStatus() != null && detailsResponse.getDbmApprovalStatus().trim().equalsIgnoreCase("AUTO APPROVED")) {
                autoApprovedHeaderView.setVisibility(View.VISIBLE);
...
//            }
            ...
            holder.AxStatuss.setText(detailsResponse.getDbmApprovalStatus());

            // Log.d("String-----------","----------"+AxStatus[position]);

            if (detailsResponse.getDbmRemarks() != null) {
                holder.RejectRemarks.setText(detailsResponse.getDbmRemarks());
            }
...
//            }
            ...
            if (AxStatus[position].equals("AUTOAPPROVE")) {
                holder.DS.setVisibility(View.VISIBLE);
            } else {
                holder.DS.setVisibility(View.GONE);
            }
