...
public class AMIndentSelection extends Activity {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appLocationService = new AppLocationService(AMIndentSelection.this);
            ...
            protected void onPostExecute(String result) {
...

                {
                    try {
                        ...
                        prgDialog.cancel();
                        Toast.makeText(AMIndentSelection.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    // Internet connection doesn't exist
                    showAlertDialog(AMIndentSelection.this, "No Internet Connection",
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder = new ViewHolder();
                LayoutInflater inflater = AMIndentSelection.this.getLayoutInflater();
