...
public class AMRejectedFragment extends Fragment {
    ...
    private String[] item_remarks_Strings;
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_rejected, container, false);
        appSharedPreferences = new AppSharedPreferences(requireContext());
        apiInterface = ApiClient.getClient().create(ApiInterface.class);
        appLocationService = new AppLocationService(getActivity());

        rejectedListView = view.findViewById(R.id.listView);
...
//                prgDialog.hide();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (statusResponse.getAmApprovalStatus()!=null && statusResponse.getAmApprovalStatus().trim().equalsIgnoreCase("REJECTED")){
...
//            }
            ...
            if(statusResponse.getAmRemarks()!=null){
                holder.RejectRemarks.setText(statusResponse.getAmRemarks());
            }

            holder.AxStatuss.setText(statusResponse.getAmApprovalStatus());
...
//                    codes4.add(L);
                    ...
                    item_remarks_Strings=new String[cody.size()];
                ...
                for (int j = 0; j < codes.size(); j++) {
                    ...
                    item_remarks_Strings[j] = cody.get(j);
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if ( !item_remarks_Strings[position].equals("")) {
                holder.item_remarks.setText(item_remarks_Strings[position]);
            }
