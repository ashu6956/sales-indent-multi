...
@Entity
public class SalesIndentRequestDetailsEntity {
    ...
    @ColumnInfo(name = "varity_code")
    @SerializedName("varity_code")
    private String varietyCode;

    @ColumnInfo(name = "varity_name")
    ...
    @ColumnInfo(name = "am_approval_status")
    ...
    @ColumnInfo(name = "am_qty")
    @SerializedName("am_qty")
    private String amQty;
    ...
    public String getAmQty() {
        return amQty;
    }

    public void setAmQty(String amQty) {
        this.amQty = amQty;
    }
    ...
    @ColumnInfo(name = "am_remarks")
    @SerializedName("am_remarks")
    private String amRemarks;
    @ColumnInfo(name = "dbm_approval_status")
...
//    }
    ...
    public String toString() {
        return "SalesIndentRequestDetailsEntity{" +
                ", IndentNo='" + IndentNo + '\'' +
                ", IndentDate='" + IndentDate + '\'' +
                ", IndentTime='" + IndentTime + '\'' +
