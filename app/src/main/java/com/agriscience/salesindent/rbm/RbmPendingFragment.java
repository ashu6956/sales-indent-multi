...
public class RbmPendingFragment extends Fragment {
...
//                prgDialog.hide();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getRbmApprovalStatus() != null && detailsResponse.getRbmApprovalStatus().trim().equalsIgnoreCase("PENDING")) {
                pendingHeaderView.setVisibility(View.VISIBLE);
