...
public class RBMScreenActivity extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rbmscreen);
        ...
        mFirebaseRemoteConfig.fetch().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(RBMScreenActivity.this, "Someting went wrong please try again",
        ...
        appLocationService = new AppLocationService(RBMScreenActivity.this);


        totcounts = (TextView) findViewById(R.id.textView47);
        update = (TextView) findViewById(R.id.textView48);

        tvTmMenu = (TextView) findViewById(R.id.tvRbmTmMenu);
        tvAmMenu = findViewById(R.id.tvRbmAmMenu);
     ...
     /*   mGoogleApiClient = new GoogleApiClient.Builder(this)
        ...
        CustomGrids adapter = new CustomGrids(RBMScreenActivity.this, web, imageId);
        ...
        if (extras != null) {
            ...
            tvAmMenu.setOnClickListener(arg0 -> {
                AMMenu();
            });
        ...
        if (appSharedPreferences.getIsTM()) {
...
//        TMMenuSave();
    ...
    public void checkwifi() {
        ...
        if (isConnectionExist || isConnectionExistMobile) {
            ...
            showAlertDialog(RBMScreenActivity.this, "No Internet Connection",
    ...
    private void indentactivity() {
      ...
      /*  if (IndentName.equals("GET MASTER")) {
        ...
        if (IndentName.equals("INDENT APPROVE")) {
            ...
            if (isConnectionExist || isConnectionExistMobile) {
                Intent intent = new Intent(this, RBMIndentApprovalProcess.class);
                intent.putExtra("Po_code", POCodeGet);
                intent.putExtra("Po_name", PONameGet);
                intent.putExtra("Tm_name", TerritoryNameGet);
                intent.putExtra("Post_code", PostCodeTransferGet);
        ...
        if (IndentName.equals("INDENT STATUS")) {
            if (appSharedPreferences.get_version() == getcurrentversioncode()) {
                Intent intent = new Intent(this, RBMReportViewActivity.class);
                intent.putExtra("Po_code", POCodeGet);
                intent.putExtra("Po_name", PONameGet);
                intent.putExtra("Tm_name", TerritoryNameGet);
                intent.putExtra("Post_code", PostCodeTransferGet);
    ...
    private void clearDB() {
        ...
        SalesIndentDataBase salesIndentDataBase = SalesIndentDataBase.getDataBase(RBMScreenActivity.this);
        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    prgDialog.cancel();
                    Toast.makeText(RBMScreenActivity.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
        }
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        RBMScreenActivity.this.startActivity(intent);
