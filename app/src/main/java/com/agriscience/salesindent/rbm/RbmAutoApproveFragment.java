...
public class RbmAutoApproveFragment extends Fragment {
...
//                    codes4.add(L);
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (detailsResponse.getRbmApprovalStatus() != null && detailsResponse.getRbmApprovalStatus().trim().equalsIgnoreCase("AUTO APPROVED")) {
                autoApprovedHeaderView.setVisibility(View.VISIBLE);
