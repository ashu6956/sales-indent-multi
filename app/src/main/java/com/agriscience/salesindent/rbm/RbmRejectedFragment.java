...
public class RbmRejectedFragment extends Fragment {
...
//                prgDialog.hide();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (statusResponse.getRbmApprovalStatus()!=null && statusResponse.getRbmApprovalStatus().trim().equalsIgnoreCase("REJECTED")){
...
//            }
            ...
            holder.AxStatuss.setText(statusResponse.getRbmApprovalStatus());
