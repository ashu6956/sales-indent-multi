...
import com.agriscience.salesindent.rbm.RBMIndentSelection;
...
public class TmPendingFragment extends Fragment {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    List<String> codey = new ArrayList<String>();
    ...
    LinearLayout pendingHeaderView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_tmpending, container, false);
        apiInterface = ApiClient.getClient().create(ApiInterface.class);
        appSharedPreferences = new AppSharedPreferences(requireContext());
        pendingListView = (ListView) view.findViewById(R.id.listView);
        pendingHeaderView = (LinearLayout) view.findViewById(R.id.Header);
    ...
    private void callSalesIndentStatusApi(String tInCharge) {
        ...
        call.enqueue(new Callback<SalesIndentStatusResponse>() {
            ...
            public void onResponse(Call<SalesIndentStatusResponse> call, Response<SalesIndentStatusResponse> response) {
                ...
                prgDialog.hide();
                Log.d("TmPending", statusResponse.toString());
                if (statusResponse.getResult() != null && statusResponse.getResult().size() > 0) {
                    Log.d("TmPending Result", statusResponse.getResult().size() + " " + statusResponse.getResult().toString());
                    ...
                    pendingListView.setAdapter(statusListAdapter);
...
//                holder.Qtys.setEnabled(false);
            ...
            if (detailsResponse.getIndentOverallStatus() != null && detailsResponse.getIndentOverallStatus().trim().equalsIgnoreCase("PENDING")) {
                pendingHeaderView.setVisibility(View.VISIBLE);
...
//
    ...
    private void IndentActivity() {
        ...
        Intent intent = new Intent(getActivity(), RBMIndentSelection.class);
...
*/
    public void getData3() {
        ...
        Log.d("FullIPDataFullIPData", "---------pen----------" + FullIPData);
...
//                    codes4.add(L);
                    ...
                    item_remarks_string = new String[codey.size()];
                ...
                for (int j = 0; j < codes.size(); j++) {
                    ...
                    item_remarks_string[j] = codey.get(j);
               ...
               /* LayoutInflater inflater = getLayoutInflater();
                ...
                // list.addFooterView(footer, null, false); */
                    ...
                    pendingListView.setAdapter(myListAdapter);
                ...
                if (Check.equals("chckfile")) {
                    ...
                    prgDialog.cancel();
                    //finish();
                    pendingHeaderView.setVisibility(View.GONE);
                }
...
//            }
            ...
            if (!item_remarks_string[position].equals("null") || !item_remarks_string[position].equals("") || item_remarks_string[position] != null) {
...
//                    Log.d("item_remarks_string","-----itemm--11---"+(item_remarks_string[position]));
                    ...
                    holder.item_remarks.setText(aa);
                }
            ...
            if (AxStatus[position].equals("PENDING")) {
                holder.DS.setVisibility(View.VISIBLE);
            } else {
                holder.DS.setVisibility(View.GONE);
            }
