...
public class TmRejectedFragment extends Fragment {
...
//    String IPAddress = "http://192.168.35.24/hyveg/Sales_Indent_App/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_tmrejected, container, false);
...
//                prgDialog.hide();
    ...
    private class SalesIndentStatusListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if ((statusResponse.getIndentOverallStatus() != null && statusResponse.getIndentOverallStatus().trim().equalsIgnoreCase("REJECTED"))) {
...
//            holder.QtyInBag.setText(statusResponse.getPackingQuantity());
...
//            }
            ...
            if(statusResponse.getTiRemarks()!=null){
                holder.item_remarks.setText(statusResponse.getTiRemarks());
            }

            holder.AxStatuss.setText(statusResponse.getIndentOverallStatus());
            if (statusResponse.getRbmRemarks() != null) {
                holder.RejectRemarks.setText(statusResponse.getRbmRemarks());
            }
            return convertView;
        }
    ...
    public void getData3() {
        ...
        Log.d("FullIPDataFullIPData", "---------rej----------" + FullIPData);
...
//                    codes4.add(L);
                    ...
                    codes9.add(R);
                    codey.add(Y);
                    // Log.d("CodeyCodey","-------------"+codey.toString());
                ...
                Log.d("CodeyCodey", "-------------" + Arrays.toString(item_remarks_string).toString());
