...
public final class SalesIndentTmpDao_Impl implements SalesIndentTmpDao {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<SalesIndentDetailsTmpEntity> __insertionAdapterOfSalesIndentDetailsTmpEntity;

  private final SharedSQLiteStatement __preparedStmtOfDeleteAllSalesIndentTmpDetails;

  public SalesIndentTmpDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfSalesIndentDetailsTmpEntity = new EntityInsertionAdapter<SalesIndentDetailsTmpEntity>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `SalesIndentDetailsTmpEntity` (`indent_no`,`SlNo`,`indent_date`,`indent_time`,`sale_organization`,`distribution_channel`,`division`,`sales_office`,`customer_code`,`customer_name`,`customer_state_id`,`crop_code`,`crop_name`,`season_code`,`season_starting_date`,`season_end_date`,`return_cut-off_date`,`variety_code`,`variety_name`,`line_item_no`,`material_code`,`material_name`,`plant`,`base_uom`,`packing_quantity`,`quantity_in_kgs_or_packets`,`required_quantity_in_kgs`,`no_of_packets_required`,`indent_overall_status`,`territory_id`,`territory_name`,`ti_id`,`ti_name`,`ti_quantity`,`ti_remarks`,`sales_region_id`,`sales_region_name`,`rbm_id`,`rbm_name`,`rbm_quantity`,`rbm_approval_status`,`rbm_approved_date`,`rbm_approved_time`,`rbm_remarks`,`sales_division_id`,`sales_division_name`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, SalesIndentDetailsTmpEntity value) {
        if (value.getIndentNo() == null) {
          stmt.bindNull(1);
        } else {
          stmt.bindString(1, value.getIndentNo());
        }
        if (value.getSlNo() == null) {
          stmt.bindNull(2);
        } else {
          stmt.bindString(2, value.getSlNo());
        }
        if (value.getIndentDate() == null) {
          stmt.bindNull(3);
        } else {
          stmt.bindString(3, value.getIndentDate());
        }
        if (value.getIndentTime() == null) {
          stmt.bindNull(4);
        } else {
          stmt.bindString(4, value.getIndentTime());
        }
        if (value.getSaleOrganization() == null) {
          stmt.bindNull(5);
        } else {
          stmt.bindString(5, value.getSaleOrganization());
        }
        if (value.getDistributionChannel() == null) {
          stmt.bindNull(6);
        } else {
          stmt.bindString(6, value.getDistributionChannel());
        }
        ...
        if (value.getSalesOffice() == null) {
          ...
          stmt.bindString(8, value.getSalesOffice());
        }
        if (value.getCustomerCode() == null) {
          stmt.bindNull(9);
        } else {
          stmt.bindString(9, value.getCustomerCode());
        }
        if (value.getCustomerName() == null) {
          stmt.bindNull(10);
        } else {
          stmt.bindString(10, value.getCustomerName());
        }
        if (value.getCustomerStateId() == null) {
          stmt.bindNull(11);
        } else {
          stmt.bindString(11, value.getCustomerStateId());
        }
        if (value.getCropCode() == null) {
          stmt.bindNull(12);
        } else {
          stmt.bindString(12, value.getCropCode());
        }
        if (value.getCropName() == null) {
          stmt.bindNull(13);
        } else {
          stmt.bindString(13, value.getCropName());
        }
        if (value.getSeasonCode() == null) {
          stmt.bindNull(14);
        } else {
          stmt.bindString(14, value.getSeasonCode());
        }
        if (value.getSeasonStartingDate() == null) {
          stmt.bindNull(15);
        } else {
          stmt.bindString(15, value.getSeasonStartingDate());
        }
        if (value.getSeasonEndDate() == null) {
          stmt.bindNull(16);
        } else {
          stmt.bindString(16, value.getSeasonEndDate());
        }
        if (value.getReturnCutOffDate() == null) {
          stmt.bindNull(17);
        } else {
          stmt.bindString(17, value.getReturnCutOffDate());
        }
        if (value.getVarietyCode() == null) {
          stmt.bindNull(18);
        } else {
          stmt.bindString(18, value.getVarietyCode());
        }
        if (value.getVarietyName() == null) {
          stmt.bindNull(19);
        } else {
          stmt.bindString(19, value.getVarietyName());
        }
        if (value.getLineItemNo() == null) {
          stmt.bindNull(20);
        } else {
          stmt.bindString(20, value.getLineItemNo());
        }
        if (value.getMaterialCode() == null) {
          stmt.bindNull(21);
        } else {
          stmt.bindString(21, value.getMaterialCode());
        }
        if (value.getMaterialName() == null) {
          stmt.bindNull(22);
        } else {
          stmt.bindString(22, value.getMaterialName());
        }
        if (value.getPlant() == null) {
          stmt.bindNull(23);
        } else {
          stmt.bindString(23, value.getPlant());
        }
        if (value.getBaseUom() == null) {
          stmt.bindNull(24);
        } else {
          stmt.bindString(24, value.getBaseUom());
        }
        if (value.getPackingQuantity() == null) {
          stmt.bindNull(25);
        } else {
          stmt.bindString(25, value.getPackingQuantity());
        }
        if (value.getQuantityInKgsOrPackets() == null) {
          stmt.bindNull(26);
        } else {
          stmt.bindString(26, value.getQuantityInKgsOrPackets());
        }
        if (value.getRequiredQuantityInKgs() == null) {
          stmt.bindNull(27);
        } else {
          stmt.bindString(27, value.getRequiredQuantityInKgs());
        }
        if (value.getNoOfPacketsRequired() == null) {
          stmt.bindNull(28);
        } else {
          stmt.bindString(28, value.getNoOfPacketsRequired());
        }
        if (value.getIndentOverAllStatus() == null) {
          stmt.bindNull(29);
        } else {
          stmt.bindString(29, value.getIndentOverAllStatus());
        }
        if (value.getTerritoryId() == null) {
          stmt.bindNull(30);
        } else {
          stmt.bindString(30, value.getTerritoryId());
        }
        if (value.getTerritoryName() == null) {
          stmt.bindNull(31);
        } else {
          stmt.bindString(31, value.getTerritoryName());
        }
        if (value.getTiId() == null) {
          stmt.bindNull(32);
        } else {
          stmt.bindString(32, value.getTiId());
        }
        if (value.getTiName() == null) {
          stmt.bindNull(33);
        } else {
          stmt.bindString(33, value.getTiName());
        }
        if (value.getTiQuantity() == null) {
          stmt.bindNull(34);
        } else {
          stmt.bindString(34, value.getTiQuantity());
        }
        if (value.getTiRemarks() == null) {
          stmt.bindNull(35);
        } else {
          stmt.bindString(35, value.getTiRemarks());
        }
        if (value.getSalesRegionId() == null) {
          stmt.bindNull(36);
        } else {
          stmt.bindString(36, value.getSalesRegionId());
        }
        if (value.getSalesRegionName() == null) {
          stmt.bindNull(37);
        } else {
          stmt.bindString(37, value.getSalesRegionName());
        }
        if (value.getRbmId() == null) {
          stmt.bindNull(38);
        } else {
          stmt.bindString(38, value.getRbmId());
        }
        ...
        if (value.getRbmQuantity() == null) {
          ...
          stmt.bindString(40, value.getRbmQuantity());
        }
        if (value.getRbmApprovalStatus() == null) {
          stmt.bindNull(41);
        } else {
          stmt.bindString(41, value.getRbmApprovalStatus());
        }
        if (value.getRbmApprovedDate() == null) {
          stmt.bindNull(42);
        } else {
          stmt.bindString(42, value.getRbmApprovedDate());
        }
        if (value.getRbmApprovedTime() == null) {
          stmt.bindNull(43);
        } else {
          stmt.bindString(43, value.getRbmApprovedTime());
        }
        if (value.getRbmRemarks() == null) {
          stmt.bindNull(44);
        } else {
          stmt.bindString(44, value.getRbmRemarks());
        }
        if (value.getSalesDivisionId() == null) {
          stmt.bindNull(45);
        } else {
          stmt.bindString(45, value.getSalesDivisionId());
        }
        if (value.getSalesDivisionName() == null) {
          stmt.bindNull(46);
        } else {
          stmt.bindString(46, value.getSalesDivisionName());
        }
      }
    };
    this.__preparedStmtOfDeleteAllSalesIndentTmpDetails = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Delete from SalesIndentDetailsTmpEntity";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insertAll(final SalesIndentDetailsTmpEntity... salesIndentDetailsTmps) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfSalesIndentDetailsTmpEntity.insert(salesIndentDetailsTmps);
  ...
  @Override
  public void deleteAllSalesIndentTmpDetails() {
    __db.assertNotSuspendingTransaction();
    final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteAllSalesIndentTmpDetails.acquire();
    __db.beginTransaction();
    try {
      ...
      __db.endTransaction();
      __preparedStmtOfDeleteAllSalesIndentTmpDetails.release(_stmt);
    }
  }

  @Override
  public List<SalesIndentDetailsTmpEntity> getAllSalesIndentTmp() {
    final String _sql = "Select * from SalesIndentDetailsTmpEntity";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
      final int _cursorIndexOfIndentNo = CursorUtil.getColumnIndexOrThrow(_cursor, "indent_no");
      final int _cursorIndexOfSlNo = CursorUtil.getColumnIndexOrThrow(_cursor, "SlNo");
      ...
      final int _cursorIndexOfReturnCutOffDate = CursorUtil.getColumnIndexOrThrow(_cursor, "return_cut-off_date");
      ...
      final List<SalesIndentDetailsTmpEntity> _result = new ArrayList<SalesIndentDetailsTmpEntity>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final SalesIndentDetailsTmpEntity _item;
        _item = new SalesIndentDetailsTmpEntity();
        ...
        final String _tmpSlNo;
        if (_cursor.isNull(_cursorIndexOfSlNo)) {
          _tmpSlNo = null;
        } else {
          _tmpSlNo = _cursor.getString(_cursorIndexOfSlNo);
        }
        _item.setSlNo(_tmpSlNo);
